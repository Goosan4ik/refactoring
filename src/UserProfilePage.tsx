...
export default function UserProfilePage({ token }: Props) {
    ...
    async function fetchPurchases() {
      try {
        const res = await axios.get("http://91.142.94.183:8080/purchases", {
          ...
          params: { page: DEFAULT_PAGE_NUMBER, size: PURCHASES_PAGE_SIZE },
        });
  ...
  const handleSubmitReview = async (filmId: string) => {
    ...
    try {
      ...
      setReviewForms((prev) => ({ ...prev, [filmId]: { rating: MIN_RATING, text: "" } }));
    } catch (err) {
              ...
              <div className="card-body text-light">
                ...
                <div className="mt-2">
                  ...
                  <input
                    ...
                    placeholder={`Рейтинг ${MIN_RATING}–${MAX_RATING}`}
